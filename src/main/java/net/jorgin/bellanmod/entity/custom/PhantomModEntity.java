package net.jorgin.bellanmod.entity.custom;
...
public class PhantomModEntity extends Animal {
    public PhantomModEntity(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob ageableMob) {
        return BellAnEntities.PHANTOMMOD.get().create(serverLevel);
    }
    @Override
