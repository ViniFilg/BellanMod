...
public class BolinhaEntity extends Animal {
    public BolinhaEntity(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    public AgeableMob getBreedOffspring(ServerLevel serverLevel, AgeableMob ageableMob) {
        return BellAnEntities.BOLINNHA.get().create(serverLevel);
    }
    @Override
